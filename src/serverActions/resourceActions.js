...
export async function getTemplateTaskResources(templateId, taskId) {
  const model = new ResourceLinks();
  return await model.getTemplateTaskResources(templateId, taskId);
}
...
export async function createResourceProjectTaskMapping(formData) {
  ...
  const model = new ResourceLinks();
  const res = await model.mapResourceToProjectTask(
    resourceId,
    projectId,
    taskId
  );
...
export async function createResourceTemplateTaskMapping(formData) {
  ...
  const resourceId = formData.get("resourceId");
  const model = new ResourceLinks();
  const res = await model.mapResourceToTemplateTask(
    resourceId,
    templateId,
    taskId
  );
...
export async function deleteResourceProjectTaskMapping(
  projectId,
  taskId,
  mapId
) {
...
export async function deleteResourceTemplateTaskMapping(
  templateId,
  taskId,
  mapId
) {
